...
<head>
  ...
  <link rel="stylesheet" href="/ProjetoExemplo/public/assets/css/variaveis.css" /><!-- Variáveis globais de design -->
  <link rel="stylesheet" href="/ProjetoExemplo/public/assets/css/componentes.css" /><!-- Componentes compartilhados  -->
  <link rel="stylesheet" href="/ProjetoExemplo/public/assets/css/agendamentoCli.css" /><!-- CSS próprio -->
...
<body class="corpoPagina">
  ...
  <nav id="navegacaoLateral" class="navegacaoLateral d-none d-md-flex flex-column align-items-center"
    ...
    <ul class="listaNavegacao list-unstyled d-flex flex-column align-items-center gap-3">
      <li>
        <a href="#" class="itemNavegacao itemNavegacaoAtivo" aria-current="page" aria-label="Agendamento">
      ...
      <li>
        <a href="index.php?uri=consultasCli" class="itemNavegacao" aria-label="Minhas consultas">
  ...
  <div class="areaConteudo">
    ...
    <header id="cabecalhoMobile" class="cabecalhoMobile d-flex d-md-none align-items-center justify-content-between">
      <a href="index.php?uri=home" class="marcaAppMobile d-flex align-items-center gap-2" aria-label="Página inicial">
        <img src="public/assets/images/logo_verde.png" alt="" class="logoAppMobile" />
        <span class="nomeApp">AAAA</span>
      </a>
      ...
      <form id="formularioAgendamento" class="gradeAgendamento estadoCarregando" novalidate>
        ...
        <div class="campoValor areaValor">
          <div class="campoValorLinha">
            ...
            <p class="valorAgendamento" data-campo="precoServico"></p>
          </div>
          <p class="textoAjuda">
        ...
        <div class="campoFormulario areaProfissional">
          ...
          <input type="text" id="inputProfissionalResponsavel" class="inputFormulario" data-campo="nomeProfissional"
            value="" readonly />
        </div>
        ...
        <div class="campoFormulario areaLocalizacao">
          ...
          <div class="dropdownCustomizado" id="dropdownLocalizacao">
            <button type="button" id="botaoDropdownLocalizacao" class="dropdownCustomizadoBotao" aria-haspopup="listbox"
              aria-expanded="false" aria-labelledby="labelLocalizacao" aria-describedby="textoLocalizacaoSelecionada">
            ...
            <ul id="listaLocalizacoes" class="dropdownCustomizadoLista" role="listbox"
              aria-labelledby="labelLocalizacao" hidden>
            </ul>
          </div>
        ...
        <div class="campoFormulario areaHorario">
          ...
          <div class="dropdownCustomizado" id="dropdownHorario">
            <button type="button" id="botaoDropdownHorario" class="dropdownCustomizadoBotao" aria-haspopup="listbox"
              aria-expanded="false" aria-labelledby="labelHorario" aria-describedby="textoHorarioSelecionado" disabled>
              <span class="material-symbols-outlined" aria-hidden="true">schedule</span>
              <span id="textoHorarioSelecionado" class="dropdownCustomizadoTexto">Selecione horário</span>
              <span class="material-symbols-outlined dropdownCustomizadoSeta" aria-hidden="true">expand_more</span>
            </button>
            <ul id="listaHorarios" class="dropdownCustomizadoLista" role="listbox" aria-labelledby="labelHorario"
              hidden>
            </ul>
          </div>
    ...
    <nav id="navegacaoInferior" class="navegacaoInferior d-flex d-md-none align-items-center justify-content-around"
      ...
      <a href="#" class="itemNavegacaoInferior itemNavegacaoInferiorAtivo" aria-current="page"
        aria-label="Agendamento">
        <span class="material-symbols-outlined" aria-hidden="true">search</span>
      </a>
      <a href="index.php?uri=consultasCli" class="itemNavegacaoInferior" aria-label="Minhas consultas">
        <span class="material-symbols-outlined" aria-hidden="true">calendar_month</span>
      </a>
  ...
  <div class="modal fade modalPadrao modalErro" id="modalServicoNaoEncontrado" tabindex="-1"
    aria-labelledby="tituloModalServicoNaoEncontrado" aria-describedby="textoModalServicoNaoEncontrado"
      ...
      <div class="modal-content">
        <div class="modal-body text-center">
          ...
          <p class="textoRodapeModal">
            ...
            <a href="#" id="linkCentralAjuda" class="linkTexto">Central de Ajuda.</a>
          </p>
        </div>
      </div>
    </div>
  ...
  <div class="modal fade modalPadrao" id="modalNaoLogado" tabindex="-1" aria-labelledby="tituloModalNaoLogado"
    aria-describedby="textoModalNaoLogado" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-body text-center">
          ...
          <p class="textoRodapeModal">
            ...
            <a href="index.php?uri=cadastrocli" id="linkCadastro" class="linkTexto">Cadastro</a>.
          </p>
        </div>
      </div>
    </div>
  ...
  <script src="/ProjetoExemplo/public/assets/js/agendamentoCli.js" defer></script>
</body>
