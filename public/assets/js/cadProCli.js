$(document).ready(function () {
    console.log("profissional.js carregado");
    ...
    $("#btnCadastrar").on("click", function () {
        ...
        $img = "cxproFoto";
        $.ajax({
            url: window.BASE_URL + "index.php?uri=profissional", //Axolote
            method: "POST",
            data: formData,
            processData: false,
            contentType: false,
    ...
    $("#btnCadClinica").on("click", function (e) {
        ...
        $.ajax({
            url: window.BASE_URL + "index.php?uri=clinica", //Axolote
            method: "POST",
            data: formData,
            processData: false,
            contentType: false,
        ...
        $.ajax({
            ...
            success: function (resposta) {
                ...
                if (resposta.trim() === "sucesso") {
                    ...
                    mostrarAlert(resposta, "danger");
                    window.location.href = window.BASE_URL + "index.php?uri=clinica";
                }
            },
    ...
    $("#btnCodigo").on("click", function (e) {
        ...
        // Define dinamicamente o e-mail e o destino
        let email = "";
        let controller = "";

        if (tipoUsuario === "profissional") {
            email = prof.email.val().trim();
            controller =  window.BASE_URL + "index.php?uri=profissional"; //Axolote
        } else if (tipoUsuario === "clinica") {
            email = cli.email.val().trim();
            controller = window.BASE_URL + "index.php?uri=clinica"; //Axolote
        }
