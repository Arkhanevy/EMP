/* ============================================================
   PÁGINA: consultasCli (Minhas consultas)
   ...
   - Verificar se a sessão do usuário é válida; se não for,
     exibir o modal "Sessão expirada" (sem botão de fechar).
   - Buscar a lista de consultas via AJAX e montar os cards
     dinamicamente (ou mostrar o estado vazio).
   - Inicializar os popovers que explicam cada status.
   - Abrir o modal de confirmação ao clicar em "Cancelar" e
     efetivar o cancelamento via AJAX, atualizando só aquele
     card (sem recarregar a lista inteira).
   ============================================================ */
